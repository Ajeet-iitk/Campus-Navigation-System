...
class touristMap { //Class touristMap consists of all the methods used.
        ...
        //     cout << "IIT Kanpur Travelling" << endl << endl;
        ...
        // cout << "*                                      '--|                        /|           * " << endl;
        // cout << "*                                         |                       '-|           * " << endl;
        // cout << "*    __/|____6hr__.-----|-----.             .----|-----.      * " << endl;
        // cout << "*    |    / |++++++++++.            |           |             |{HauzKhas}|      * " << endl;
        // cout << "*    |_| {AppuGhar} |_ 4hr_ |  {RedFort}|             .----------.      * " << endl;
        // cout << "*     _|            |            |           |_6hr _____|__     * " << endl;
        // cout << "*     |   ******            .+++++++++++.       /              |        * " << endl;
        // cout << "*     |                                                 5hr            |        * " << endl;
        // cout << "*     |                                                /               |        * " << endl;
        // cout << "*     2hr                    .-++-----++--.        .^^^^^^^^^^^^.     3hr       * " << endl;
        // cout << "*     |                   _ |{ DaryaGanj}|___|{ IndiaGate}|      |        * " << endl;
        // cout << "*     |                  /   |            |   1hr  |            |      |        * " << endl;
        // cout << "*     |__.***. 1hr   '--+++++++++-.        .^^^^^^^^/^^^^.     |        * " << endl;
        // cout << "*          |{Chandani| /                                   3hr         |        * " << endl;
        // cout << "*          |  Chowk} |/              /|----------.        /            |        * " << endl;
        // cout << "*          |         |              / |          |      <<<<           >>>>     * " << endl;
        // cout << "*     ___.---------.            ./--|----------|       {{ LotusTemple }}      * " << endl;
        // cout << "*     |                           |              |        {{{{       }}}}       * " << endl;
        // cout << "*     2hr                         |{JantarMantar}|          {{{    }}}          * " << endl;
        // cout << "*     |_.---------. ___3hr _|              |----6hr-----////////          * " << endl;
        // cout << "*          | {Jama   |            .--------------.               |              * " << endl;
        // cout << "*          |  Masjid}|                                           |              * " << endl;
        // cout << "*          |         |                                         -----            * " << endl;
        // cout << "*          .---------.                                             |            * " << endl;
